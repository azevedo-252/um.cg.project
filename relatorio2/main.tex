...
\input{tex/edificio_tesouro}

\section{Balas}
\input{tex_files/balas}
\newpage
...
\section{Vidas}
\input{tex_files/vidas}

\section{Colisões}
\input{tex_files/colisoes}

\section{Salto}
\input{tex_files/salto}

\section{Iluminação}
\input{tex_files/light}

\section{Game Mode}
\input{tex_files/game_mode}

\newpage

% ------------------ CONCLUSAO
\chapter{Conclusão}
\input{tex_files/conclusao}

%\chapter*{Bibliografia}

\chapter{Referências}
\input{tex_files/referencias}
